...
data "local_file" "_defaults" {
  filename = "${path.cwd}/config/_defaults.yaml"
}
data "local_file" "config" {
  filename = "${path.cwd}/config/main-config.yaml"
  #   filename = "./config/${terraform.workspace}/main-config.yml"
}
